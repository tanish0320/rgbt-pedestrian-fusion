...
def main():
    print("Generating PERSON2_COMPLETE_DOCUMENTATION.md...")
    
    doc_content = """# PERSON 2 COMPLETE DOCUMENTATION
...
"""
    ...
    root_path = "C:/Claude_projects/Object Detection/mmdet-rgbtdroneperson/PERSON2_COMPLETE_DOCUMENTATION.md"
    with open(root_path, "w", encoding="utf-8") as f:
        f.write(doc_content)
        
    # Also write to artifact folder
    artifact_path = "C:/Users/Tanish/.gemini/antigravity-cli/brain/be1b9b2d-ac42-4ac6-86d9-67ac0d4133b9/PERSON2_COMPLETE_DOCUMENTATION.md"
    with open(artifact_path, "w", encoding="utf-8") as f:
        f.write(doc_content)
        
    print("Master technical documentation successfully compiled and saved!")
