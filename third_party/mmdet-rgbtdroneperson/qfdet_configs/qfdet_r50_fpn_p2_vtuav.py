"""Phase 3 fusion-v1 training config: baseline QFDet + P2/stride-4 fusion level +
modality-dropout fine-tuning (docs/phase3_fusion_plan.md).

Two changes from qfdet_r50_fpn_1x_vtuav.py, both additive/config-only — no code changes,
verified level-count-agnostic across FPN/heads/assigner/fusion path before this was written:
...
2. RandomMasking added to train_pipeline (before normalization, since zeroing after would
